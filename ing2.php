...
<tr>
  ...
  <td><form method="post" action="./actualizarIng2.php">
	<input type="hidden" name="Nombre2" value="<?php echo $row['NombreIng'];?>">

<button id="actualizar" type="submit"><i class="fas fa-edit"></i></button></td>
  <td> <form method="post" action="./php/eliminarIng.php">
